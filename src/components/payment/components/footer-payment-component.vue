<template>
  <div
    class="flex justify-between lg:px-6 px-4 py-4 bg-white lg:static sticky bottom-0 z-50 footer-box-simple"
  >
    <h4 class="text-base text-nowrap whitespace-nowrap">
    ...
    <div class="flex space-x-2">
      ...
      >
        <img
          src="/imgs/global-sign.svg"
          class="h-6 w-11 object-contain"
          alt="global-sign"
        />
      </nuxt-link>
      <nuxt-link
        href="https://seal.controlcase.com/index.php?page=showCert&cId=3865876849"
        target="_blank"
      >
        <img
